...
/**
 * Класс для команды добавления элемента, если его значение больше максимального элемента в коллекции.
 * Используется для проверки, превышает ли новый элемент существующий максимальный элемент.
 */
public class AddIfMaxCommand implements Command {
    private MusicBandManager manager;
    private Scanner scanner;

    public AddIfMaxCommand(MusicBandManager manager, Scanner scanner) {
    ...
    public void execute() {
        ...
        System.out.println("Добавление нового элемента, если он окажется больше максимального...");
        ...
        if (manager.isMax(newBand)) {
            manager.addElement(newBand);
            System.out.println("Новый элемент добавлен в коллекцию.");
        } else {
            System.out.println("Новый элемент не был добавлен, так как он меньше или равен максимальному элементу коллекции.");
        }
    }
